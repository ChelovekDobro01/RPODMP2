    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdapterView.OnItemSelectedListener itemSelectedListener = new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                devicePriceTextView.setText("Price: " + item.get_price() + "$");
                deviceEnergyTextView.setText("Energy consumption: " + item.get_energyConsumption() + "W/h");
                deviceProfitTextView.setText("Profit: " + item.get_profit() + "$/h");
                resultTextView.setVisibility(View.INVISIBLE);
            }

            @Override
            public void onNothingSelected(AdapterView<?> parent) {
                devicePriceTextView.setText("Price:");
                deviceEnergyTextView.setText("Energy consumption:");
                deviceProfitTextView.setText("Profit:");
            }
        };
        ...
        View.OnClickListener clickListener = new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    String resultString = String.format("Payback in %d days", days);
                    resultTextView.setText(resultString);
                    resultTextView.setVisibility(View.VISIBLE);
                }
                catch(NumberFormatException e){
                    energyPriceEditText.setError("Wrong number format");
                }
            }
        };
